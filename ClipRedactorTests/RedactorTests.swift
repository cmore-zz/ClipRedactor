...
final class RedactorTests: XCTestCase {
    ...
    func testBuiltinOverrideDeletionPersists() throws {
        let tempDir = FileManager.default.temporaryDirectory
        let overrideFile = tempDir.appendingPathComponent("deletionTest.json")
        ...
        """
        try json.write(to: overrideFile, atomically: true, encoding: .utf8)
        print("Wrote override file to: \(overrideFile.path)")
        print("Contents:\n\(json)")

        let redactor = Redactor(overrideFile: overrideFile)
        let result = redactor.redact("sk-abcdef0123456789abcdef0123456789abcdef0123456789")
        XCTAssertEqual(result, "sk-abcdef0123456789abcdef0123456789abcdef0123456789", "Builtin redaction should be disabled")
    }
